...
BEGIN_MESSAGE_MAP(CDDEMonitorApp, CWinApp)
...
// 僅有的一個 CDDEMonitorApp 物件

CDDEMonitorApp theApp;


// CDDEMonitorApp 初始設定

BOOL CDDEMonitorApp::InitInstance()
{
